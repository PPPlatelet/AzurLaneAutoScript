...
class Winapi(PlatformBase, WinapiFunctions):
    """
    Winapi base class.
    """
    ...
    def get_focused_window(self) -> Tuple[HWND, Optional[WINDOWPLACEMENT]]:
        """
    ...
    def set_focus_to_window(self, focusedwindow: Tuple[HWND, Optional[WINDOWPLACEMENT]]) -> bool:
        """
        Focus to a window.
    ...
    def execute(
        ...
        Examples:
            >>> print(self.execute('"E:/Program Files/Netease/MuMu Player 12/shell/MuMuPlayer.exe" -v 1', False, True))
    ...
    def get_hwnds(self, pid: int) -> List[HWND]:
        """
    ...
    def get_cmdline(self, pid: int) -> str:
        ...
        Examples:
            >>> print(self.get_cmdline(12345))
            '"E:/Program Files/Netease/MuMu Player 12/shell/MuMuPlayer.exe" -v 1'
        """
        pass

    def kill_process_by_regex(self, regex: str) -> int:
        """
    ...
    def _get_process_creation_time(self, pid: int) -> Optional[int]:
        """
    ...
    def _get_thread_creation_time(self, tid: int) -> Optional[int]:
        """
    ...
    def get_thread(self, pid: int) -> int:
        """
    ...
    def _get_process(self, pid: int) -> PROCESS_INFORMATION:
        """
    ...
    def get_process(self, instance: EmulatorInstance) -> PROCESS_INFORMATION:
        """
    ...
    def switch_window(self, hwnds: List[HWND], arg: int = None) -> bool:
        """
    ...
    def get_parent_pid(self, pid: int) -> int:
        """
    ...
    def get_exit_code(self, pid: int) -> int:
        """
    ...
    def is_running(self, pid: int = 0, ppid: int = 0) -> bool:
        """
